...
#![allow(clippy::box_default, clippy::type_complexity, clippy::too_many_arguments, clippy::collapsible_if, clippy::collapsible_else_if, clippy::needless_range_loop, clippy::manual_range_contains, clippy::new_without_default)]
